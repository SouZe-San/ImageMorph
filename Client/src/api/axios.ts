...
export const singIn = (userData: IRegisterUser) =>
  axi.post("user/signup", userData);
...
export const sketch2image = (promptData: FormData) =>
  axiosPrivate.post("image/sketch-2-image", promptData);
